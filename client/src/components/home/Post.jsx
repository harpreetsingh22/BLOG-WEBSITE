...
const Post=()=>{
    ...
    return (
        ...
        <Box className={classes.container}>
           ...
           <Typography className={classes.heading}>Harry</Typography>
           <Typography className={classes.text}>Author : Harry</Typography>
           <Typography className={classes.detail}>Hi from Harry!!</Typography>
